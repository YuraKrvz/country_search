...
function ListCountries({filteredCountries, setFilteredCountries}) {
   
   return (
      <Section>
      <SearchToggle filteredCountries={filteredCountries} setFilteredCountries={setFilteredCountries}  />
